...
## [3.0.0](https://github.com/bitwise-media-group/flux-manifests/compare/v2.0.0...v3.0.0) (2026-09-18)


### ⚠ BREAKING CHANGES

* the artifact layout, the FluxInstance sync url and the cluster-vars contract change. Clusters sync oci://<registry>/manifests/platform (FLUX_SYNC_URL, PLATFORM_TREE) and must publish PLATFORM_COMPONENTS, PLATFORM_DOMAIN and DEX_CLIENTS; STACK_COMPONENTS, FLUX_SYNC_PATH, PATCHY_DOMAIN, PATCHY_EVALUATION, AGENT_*, CLAUDE_*, SCC_* and KUBECTL_OIDC_* are no longer read. The Gateway serves one wildcard listener (platform-tls replaces patchy-tls); routes attach by hostname from gateway-access-labelled namespaces. Applications, patchy included, deploy from their own manifest images. See README: Migrating from 3.x.
...
* **aws:** deploy the AWS Load Balancer Controller ([efd1486](https://github.com/bitwise-media-group/flux-manifests/commit/efd14860b0c2e2e77edb4cd6273a1d390a31e818))
* **aws:** elect an internal Gateway NLB via GATEWAY_NLB_SCHEME ([e7b38b4](https://github.com/bitwise-media-group/flux-manifests/commit/e7b38b4c27a53b96cca6a8182d13eb9e0f2804ed))
* **aws:** filter external-dns on both split-horizon zone ids ([3535b07](https://github.com/bitwise-media-group/flux-manifests/commit/3535b0777e1779de991bcd508a6912e4149ef004))
* **aws:** hand cilium off from terraform to flux after gateway API CRDs establish ([5a2d1d0](https://github.com/bitwise-media-group/flux-manifests/commit/5a2d1d01457c9d0d839256dac6a7b987df9f92ec))
...
* publish the platform as an entrypoint plus one image per component ([d20a47b](https://github.com/bitwise-media-group/flux-manifests/commit/d20a47b1b21fcf333d1451a372a5be83b81f2ca2))
...
* **aws:** serve each Route53 zone flavour with its own external-dns ([a7b804d](https://github.com/bitwise-media-group/flux-manifests/commit/a7b804d349650ee663af7518b70151c1a0235652))
...
* **deps:** update aws-actions/configure-aws-credentials action to v6.2.4 ([#64](https://github.com/bitwise-media-group/flux-manifests/issues/64)) ([27da7e8](https://github.com/bitwise-media-group/flux-manifests/commit/27da7e815bd7300baa75a34f84712dad8f9117c1))
* **deps:** update aws-actions/configure-aws-credentials action to v6.3.0 ([#65](https://github.com/bitwise-media-group/flux-manifests/issues/65)) ([4a82eee](https://github.com/bitwise-media-group/flux-manifests/commit/4a82eeee2e6a0a68be3022750ffb913cc0c7bc9d))
...
* **deps:** update bitwise-media-group/github-workflows action to v6.3.0 ([#59](https://github.com/bitwise-media-group/flux-manifests/issues/59)) ([e8d6acc](https://github.com/bitwise-media-group/flux-manifests/commit/e8d6accf9f8f6df1989c0fff76f622a8f343b9ec))
...
* **deps:** update fluxcd/flux2 action to v2.9.5 ([#56](https://github.com/bitwise-media-group/flux-manifests/issues/56)) ([0aa50e2](https://github.com/bitwise-media-group/flux-manifests/commit/0aa50e2679cfce0187b2cdb696e28c4fdfd8be4e))
* **flux-web:** admit each cloud's gateway data plane to the web UI ([697e8ae](https://github.com/bitwise-media-group/flux-manifests/commit/697e8ae57af326c513b3197c9551a78556fe123a))
